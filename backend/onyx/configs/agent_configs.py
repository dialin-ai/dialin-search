...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_DOCUMENT_VERIFICATION = 6 # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_DOCUMENT_VERIFICATION = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_GENERAL_GENERATION = 90  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBQUESTION_GENERATION = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_GENERATION = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_INITIAL_ANSWER_GENERATION = 30 # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_INITIAL_ANSWER_GENERATION = 45  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_GENERATION = 30 # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_CHECK = 8  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_CHECK = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_SUBQUESTION_GENERATION = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_SUBQUESTION_GENERATION = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_QUERY_REWRITING_GENERATION = 5  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_QUERY_REWRITING_GENERATION = 5  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_HISTORY_SUMMARY_GENERATION = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_HISTORY_SUMMARY_GENERATION = 10  # in seconds

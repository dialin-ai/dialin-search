...
import dialinIcon from "../../../public/logo.png";
import dialinLogoTypeIcon from "../../../public/logotype.png";
...
export const DialinIcon = ({
  size = 16,
  className = defaultTailwindCSS,
}: IconProps) => {
  return <LogoIcon size={size} className={className} src={dialinIcon} />;
};

export const DialinLogoTypeIcon = ({
  size = 16,
  className = defaultTailwindCSS,
}: IconProps) => {
  return <LogoTypeIcon size={size} className={className} src={dialinLogoTypeIcon} />;
};
